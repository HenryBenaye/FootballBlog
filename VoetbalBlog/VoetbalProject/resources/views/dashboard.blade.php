...
{{--    </x-slot>--}}
    <!-- Modal toggle -->
    <button data-modal-target="newTweet-modal" data-modal-toggle="newTweet-modal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
        New Tweet
    </button>
                    ...
                    <div class="p-2 flex items-center">
                        ...
                        <div class="w-full flex justify-end">
                            <div class="flex flex-row-reverse">
                                ...
                                <button id="likeButton" value="{{$post->id}}" type="button" class="bg-white w-full flex justify-end">
                                        <svg xmlns="http://www.w3.org/2000/svg"  value="{{$post->like[0]->id ?? 'none'}}" style="pointer-events: none" fill="{{count($post->like) ? "red" : "none"}}" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="hover:scale-110 w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
                                        </svg>
                                </button>
                                <div>
                                    <button data-modal-target="newComment-modal" data-modal-toggle="newComment-modal">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
{{--                                </li>--}}
        ...
        <!-- newComment modal -->
        <div id="newComment-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        <form class="space-y-6" method="post" action="{{route('comment.store', $post->id)}}">
                            ...
                            @csrf
                            <div>
                                <textarea style="resize: none;" name="comment" class="bg-gray-50 border resize:none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="What's the score" required></textarea>
                            </div>
    ...
    <!-- newTweet modal -->
    <div id="newTweet-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
        <div class="relative w-full h-full max-w-md md:h-auto">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="authentication-modal">
